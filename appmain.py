...
def index():
    ...
    show_list_temp = [
        ...
        {"标题": "数据总览","数值": [9762.4,838.2,46.3],"内容": ["年营收(万元)","月营收(万元)","日营收(万元)"]},              # 顺序表一
        {"标题": "实时保单数据","列": ["网点名称","部门","年限","年缴(万元)","标保(万元)","时间"],"保单": sheet_data_list_1},  # 顺序表二
        {"标题": "本月营收统计(万元)",},                                                                                    # 顺序表三
        {"标题": "年度各类险种营收对比"},                                                                                   # 顺序表四
        {"标题": "人力资源部指标数据",                                                                                      # 顺序表五
            "表一":["单位:人","标准人力","绩优人力","新人有效人力"],
            "表二":["单位:%","当季度参训新人晋星率","晋星班参训率","晋级班参训率"],
            "表三":["单位:%","有效活动率","上岗入营率","培训出勤率"],
        },        
        {"标题": "一年内新人有效人力季度占比图",}                                                                                               # 顺序表六
    ]
